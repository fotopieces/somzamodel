...
<div align="center"><h2>รายการสินค้า</h2></div>
		...
		<div id="myInstance1" >
		<table style="width: 100%"  border="1" style="border-color: #CCCCCC">
		<?php 	
			...
			<table border="1" style="border-color: #CCCCCC">
				...
				<?php }?>
						...
						<td align="center"><h6><?=($listOder->item_price*$objData->typePaper)-((($listOder->item_price*$objData->typePaper)/$minusOut)*$minus) ?></h6></td>
						<td align="center"><h6><?=$listOder->item_piece ?></h6></td>
						<td align="center"><h6><?=(($listOder->item_price*$objData->typePaper)-((($listOder->item_price*$objData->typePaper)/$minusOut)*$minus))*$listOder->item_piece ?></h6></td>
				...
				<td colspan="4" align="right"><h6>รวม&nbsp;&nbsp;&nbsp;&nbsp;</h6></td>
				<td align="center"><h6><?=$sumpiece?> ชิ้น</h6></td>
				<td align="center"><h6><?=$sumprice?> บาท</h6></td>
				...
				<td colspan="4" align="right"><h6>ค่าส่ง&nbsp;&nbsp;&nbsp;&nbsp;</h6></td>
				<td align="center"><h6>
				...
				<td align="center"><h6><?=$oders->sendtype?> บาท</h6></td>
				...
				<tr  style="background-color: #FF9900;">
				<td colspan="5" align="right"><h6>รวมราคา + ค่าส่ง&nbsp;&nbsp;&nbsp;&nbsp;</h6></td>
			
				<td align="center"><h6><?=$sumprice+$oders->sendtype?> บาท</h6></td>
