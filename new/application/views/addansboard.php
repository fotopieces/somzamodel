...
<div id="main">
  <div id="middle">
  <form action="<?=url::base()?>board/saveansadd" id="fms"  method="post" enctype="multipart/form-data">
    <div align="center">
      <table width="396" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="425" colspan="3"><table width="49%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><div align="center" class="style1">ตอบกระทู้</div></td>
              </tr>
            <tr>
              ...
              <input type="hidden" name="board_id" id="board_id" value="<?=$id?>" />
                <textarea name="detail" id="detail"  style="width: 710px" rows="10"  ><span id="data" style="font-size:13px"></span></textarea>
              </div></td>
              </tr>
            ...
            <tr>
              <td><div align="center">
                 <input type="submit" name="Submit"  id="submit"  onclick="dosummit()" class="btn btn btn-warning btn btn-warning"   value="ตอบกระทู้" />
                <input type="button" name="Submit2" class="btn "  value="ยกเลิก" onclick="javascript:parent.$.fancybox.close()" />
                <font color="red"><div id="msgsummit"></div></font>
